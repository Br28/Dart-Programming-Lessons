void main() {
  ...
  print('Eligible to rent movies? ${age > 20 && id == true}');
  ...
  String type = 'Bike';
  String output = type == 'Bike'
      ? '\$10'
      : type == 'Car'
          ? ' \$20'
          : '\$30';
  print('You will pay $output to enter the Wild Life Park');
  ...
  print("Valid email address ? ${email.contains('@')}");
  print("Valid email address ? ${email.contains('.')}");
  ...
  final String fullNameLength = fullName.length.toString();
